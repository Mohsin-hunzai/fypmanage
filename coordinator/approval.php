<div class="w3-container">
  <div class="w3-card-2">
    ...
    $studentconcept = mysqli_query($dbcon, "SELECT * FROM conceptnote WHERE conceptid = '$concept' ") or die(mysqli_error());
    $concept_note=mysqli_fetch_array($studentconcept);
    $approval = $concept_note['approval'];
    if ($approval =="waiting")
    {
      $asql = mysqli_query($dbcon, "UPDATE conceptnote SET approval='approved' WHERE conceptid = '$concept'") or die(mysqli_error($dbcon));
